...
|-----|------|---------|---------|------------------|------|
| 🥇1 | 基于分数的动态节点 | 8,788 | 11,876 | 11.4 | 动态分配 |
| 🥈2 | 平滑度评估函数 | 7,998 | - | 3.9 | 深度 2 |
| 🥉3 | 固定深度 2 | 7,880 | - | 6.1 | 完整游戏 |
| 4 | 加权评估 | 7,626 | - | 5.6 | 2×空格 + 最大瓦片 |
| 5 | 固定深度 2 | 7,583 | 9,352 | 6.1 | 50 局游戏 |
| 6 | 进化最终 | 7,198 | - | - | GP 进化 |
| 7 | 简单评估 | 7,149 | - | 5.9 | 空格 + 最大瓦片 |
| 8 | 节点预算 500 | 6,492 | 11,876 | 23.9 | 快速 |
| 9 | 固定深度 1 | 5,710 | - | 474.5 | 极速 |
| 10 | 节点预算 10k | 5,548 | 11,972 | 2.1 | 平衡 |
...
1. **生产环境推荐配置**：
   - **极速模式**: 100-500 节点，20-80 games/sec，平均分 ~4-6k
   - **平衡模式**: 基于分数的动态分配 (1k-10k 节点)，10+ games/sec，平均分 ~8k
   - **质量模式**: 固定 10k 节点或深度 2，2-6 games/sec，平均分 ~7-8k

2. **优化要点**：
   - 基于分数的动态节点分配是明显的赢家，能根据游戏进程自适应调整计算资源
   - 在空格数多时减少搜索深度，空格数少时增加搜索深度
   - 500 节点是性价比最高的配置点
